...
/**
 * Servlet implementation class ReplyPageController
 */
@WebServlet("/reply.ad")
public class ReplyPageController extends HttpServlet {
	...
	protected void doGet(HttpServletRequest request, HttpServletResponse response)
		...
		listCount = new AdminService().selectAllReplyCount();
		...
		ArrayList<ReplyList> list = new AdminService().selectAllReplyList(pi);

		request.setAttribute("list", list);

		request.getRequestDispatcher("views/adminPage/adminReply.jsp").forward(request, response);

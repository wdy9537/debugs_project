...
/**
 * Servlet implementation class QnaPageController
 */
@WebServlet("/qna.ad")
public class QnaPageController extends HttpServlet {
	...
	protected void doGet(HttpServletRequest request, HttpServletResponse response)
		...
		listCount = new AdminService().selectAllQnaCount();
		...
		ArrayList<Qna> list = new AdminService().selectAllQnaList(pi);

		request.setAttribute("list", list);

		request.getRequestDispatcher("views/adminPage/adminQna.jsp").forward(request, response);

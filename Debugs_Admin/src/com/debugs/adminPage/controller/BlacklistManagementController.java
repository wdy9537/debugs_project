...
/**
 * Servlet implementation class BlacklistManagementController
 */
@WebServlet("/blacklist.ad")
public class BlacklistManagementController extends HttpServlet {
	...
	protected void doGet(HttpServletRequest request, HttpServletResponse response)
		...
		ArrayList<Blacklist> list = new AdminService().selectBlacklistList(pi);

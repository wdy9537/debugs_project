...
/**
 * Servlet implementation class SearchBlacklistController
 */
@WebServlet("/searchblacklist.ad")
public class SearchBlacklistController extends HttpServlet {
	...
	protected void doPost(HttpServletRequest request, HttpServletResponse response)
		...
		listCount = new AdminService().selectBlacklistListCount();
		...
		String blacklistName = request.getParameter("searchblacklistname");

		ArrayList<Blacklist> list = new AdminService().searchBlacklist(pi, blacklistName);

		request.setAttribute("list", list);

		request.getRequestDispatcher("views/adminPage/blacklistManagementPage.jsp").forward(request, response);
	}

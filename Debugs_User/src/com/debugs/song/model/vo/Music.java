...
public class Music {
	...
	public Music(String musicTitle, String musicDetail) {
		super();
		this.musicTitle = musicTitle;
		this.musicDetail = musicDetail;
	}

	public Music(int albumNo, String musicTitle) {
		super();
		this.albumNo = albumNo;
		this.musicTitle = musicTitle;
	}

	public Music(int musicNo, String musicTitle, String musicTime, String musicGenre,  String musicLyrics) {
		super();

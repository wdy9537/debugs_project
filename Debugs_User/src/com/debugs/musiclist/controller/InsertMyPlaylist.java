...
/**
 * Servlet implementation class InsertMyPlaylist
 */
@WebServlet("/insertMy.pl")
public class InsertMyPlaylist extends HttpServlet {
	private static final long serialVersionUID = 1L;
       
    /**
     * @see HttpServlet#HttpServlet()
     */
    public InsertMyPlaylist() {
        super();
	...
	protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		int result = new MusiclistService().insertMyPlaylist(musicNo, plNo);

...
/**
 * Servlet implementation class InsertPlaylist
 */
@WebServlet("/add.pl")
public class AddPlaylist extends HttpServlet {
	...
	protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		String plSubject = request.getParameter("add_playlist_subject");
		
		int result = new MusiclistService().addPlaylist(userNo, plSubject);

            ...
            <td>
                <div class="loginbox" >
                    <form id="enroll-form"  action="<%= contextPath %>/update.me" method="post">
                        <span><h2><strong>개인정보 수정</strong></h2></span>
                        <pre style="color: #4c4c4c;" >        *디버스에 등록된 개인정보를 수정 할 수 있습니다.최신 정보로 관리해주세요.</pre>
                        <br>
                        <!--작성하지 않아도 문제는 없음-->
                        <fieldset>
                         <legend>회원가입 구역</legend>
                          ...
                          <input type="password" id="loginpw" name="userPwd"  placeholder="비밀번호를 입력해 주세요" onblur="idCheck_3()" required>
                          <label for="loginpw">&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<strong>비밀번호 확인</strong></label>
                          <input type="password" id="loginpw2" placeholder="비밀번호를 확인해 주세요">
                         
                         
                          <label for="loginnumber">&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<strong>주민번호</strong></label>
                          <input type="text" id="loginnumber" name="userSsn" placeholder="주민번호를 입력해 주세요" onblur="ssnCheck()" required>
                         
                          <label for="loginphone">&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<strong>휴대폰 번호</strong></label>
                          <input type="text" id="loginphone" name="userPhone"   placeholder="번호를 입력해 주세요" onblur="phoneCheck_1()" style="width: 400px;" required>
...
<%-- 	function onload_proc(){
		 ...
		 alert("onload_proc  userId : " + <%=loginUser %>);
	  	
		loginpw.value = "nato01000";
		loginpw2.value = "nato01000";
		loginname.value = "김민재";
		loginnumber.value = "123456-1234567";
   ...
   function phoneCheck(){ 
       ...
       alert("phoneCheck  1"); 
          ...
          const $userPhone = $("#enroll-form input[name=userPhone]");
          ...
          $.ajax(
          {
        	 ...
        	 {
        		 alert("phoneCheck  success   result "  +  result);  
